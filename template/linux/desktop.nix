...
{
  options.jw.fingerprint = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Enable fingerprint sensor + lid handling";
  };
  config = lib.mkMerge [
    {
      ...
      # 1Password requires a polkit policy owner.
      programs._1password-gui = {
        enable = true;
        polkitPolicyOwners = [ "jw910731" ];
      };
    }
    (lib.mkIf config.jw.fingerprint {
